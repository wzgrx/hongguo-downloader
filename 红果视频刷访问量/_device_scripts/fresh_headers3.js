...
var USER_ID = "671f127c000000001d031c2e";
frida_java_bridge_default.perform(function() {
  emit("+", "Java ready");
  setTimeout(function() {
    try {
      var X = frida_java_bridge_default.use("com.xingin.shield.http.XhsHttpInterceptor");
      var inst = X.newInstance(frida_java_bridge_default.use("java.lang.String").$new("main"));
      var client = frida_java_bridge_default.use("okhttp3.OkHttpClient$Builder").$new().addInterceptor(inst).build();
      var B = frida_java_bridge_default.use("okhttp3.Request$Builder").$new();
      var u = "https://edith.xiaohongshu.com/api/sns/v4/note/user/posted?user_id=" + USER_ID + "&sub_tag_id=&cursor=&num=10&use_cursor=true&pin_note_id=&pin_note_ids=&source=user_profile&privacy_type=2&show_empty_state_v3=false";
      B.url(frida_java_bridge_default.use("java.net.URL").$new(frida_java_bridge_default.use("java.lang.String").$new(u)));
      var RB = B.get().addHeader("xy-direction", "26").addHeader("X-B3-TraceId", "d1d1dcc618180400").addHeader("x-xray-traceid", "d000ca626f0e7dcd6b4e39dc98b57e85").addHeader("xy-scene", "fs=0&point=789").addHeader("xy-tt", "1,jValdl7n7rwOo8f3BTPRLBUkaRIVi6J95a5x-8jN3TOjWxKGlD-jEdssOxJP-hA6ojh9O_6jEVihHDyD7zaut6XQWnKhFW4xdlIBgCLL6Ob4WK0KCTMSxRCriQr7kA0ekDcF_v9P,1786818254").addHeader("x-legacy-did", "f38d6819-05ef-3453-9c0a-913bfa227a7e").addHeader("x-legacy-fid", "").addHeader("x-legacy-sid", "session.1786695903083871014449").addHeader("x-mini-gid", "7f6ff9e162fa54a563a89b69ac1ece5ac598c939473593d177ddaa63").addHeader("x-mini-s1", "AFkAAAABPrEgE1RVbzkcUGxM2hYHvYmuEs90z23fb50hW+HnVHxQ9nEx9ij4haYVeN1JPuAnp6s+R9UUtZs=").addHeader("x-mini-sig", "b083492d947c1a7ab6c8ce430a250dff5d6d7d8ae319505df543f672f8c3b73b").addHeader("x-mini-mua", ".MmRy-G6MAGEVeE9mGIvkoN3z-qJd56-oD7e9191mi9N7YdqA4DbXoJPJ4FwuoKEAxO92gP4xeKw8Tt9b3ezXu7ZPeoqHM454I1UrLA6IIyZs2apmA0qGYIcdkNKk6ImFBgl-AV_TMkwLE7exdE45WvIouC_6F5Psvd1C75W6gk05TA6PsxkQY9WdYSphV2fcyswUQkEVX7_HzqvqJVP2dJh_qP6TsZVyDODJqi3rcFx8oYHalQKGAtvFmH_AA5BUPGaTT-ySm_I5vCNDEHx2jh-24hlgbCCy57xRyo1d3dDzC-QqxzKFVTb57D45GwTno6v7rSGNhJ8FoExmRkarmgsobyhHXL3tpeC8EQj6KeDzSFP0pkxrKyKsCfF-tTjekckagremdDdYqOoP5BA-Vl9BttcNQScHAt-7tFmS02rTghttohgKrVHn1K41TpQPyOcpcBSWLJLZJ-7G5nk4KTFkw1eW5VAF9Oc3rQhtLnj3ucKBmSluP7sYrLd3LuYzRn7zE47fshC6zQUHONnmMbOIqCwChs8CKfwD5xX8sh3SBTPIGZ9ibW9ICIi2IvCcfK865M0iNk0saX5wi9YyhxlDs4B67-ADkqnack5JUe2a0tiPRYodtLt38UaGYLlyL51tFQTiF5KNoXftHnta6V0bc2SHLn3n_1VI3uuSDQ4MGoi1i_58EYfg2K7pi3nFq2IUOq7QFQaEABRiYg2yjkfpNeWrCyaS7oCWDVKj_aSyGdyy6gp5vclXAkV7ygvcZIJN178ioexJCTcoByrVK948fOLJ7Qw9mCFKUwEXZhMgtySKBjWhXwTtT1LHFPoMuW5rQVOh7SMR5-w051Kz887fY36z7q7MLvyySaAb5nS80JnHsOy2C_sa2qh9B-jntv3AqT-6TPW_etJrc0PKY7lL4IaEYY_rdwWVkeaar4PtV_KNbYnb7A1DIhkbnWZQmbulhvq0PowTangAa0Inv7KuQvc1OqPErYv4nnksxCAeFGnULuz4OWpu8pgIvVKNTzA6W1TocyBrvmAYpXVTC3pDlWL9TOzd8owwXMh_R4hMMuP6SKxukXwLSCpUjDcw6P8ScPozeoqPcIgHOtvOKf_N3dKFfhksBUW-ojC4GtHU8A2aHfL0Kcz5nU7intyypu1GG87CFOS_JjC4M9l16P-mDriDcoc0ImrljFA-_IUlkXVTwyY7xreVuk0mjzWhPUSBxFm1yDvQ8bsANaBp4VzNL6_skFSs8zFSWJElWgl-aiJIQQZ07DnvUCFYcS7ixhR-7K6r-l7uIRe6-Uo21p4uiBmQi-sv6Qu8ARChfnhA9Zjm_6G85yB4UhGEMFqE3JZxWEgOqpavZpVZ7EwO_rwsmiR7WWNIPavHSl3cDiAnb0rEYCqJVrgEujMsGqPkJD51VV9BGT6fiNPq7TpFaQ.").addHeader("xy-common-params", "fid=&gid=7f6ff9e162fa54a563a89b69ac1ece5ac598c939473593d177ddaa63&device_model=pad&tz=Asia%2FShanghai&channel=Xiaomi&versionName=9.42.0&deviceId=f38d6819-05ef-3453-9c0a-913bfa227a7e&platform=android&sid=session.1786695903083871014449&identifier_flag=4&cpu_abi=arm64-v8a&nqe_score=79&project_id=ECFAAF&x_trace_page_current=user_page&lang=zh-Hans&app_id=ECFAAF01&uis=light&teenager=0&active_ctry=CN&cpu_name=mt8799&dlang=zh&data_ctry=CN&SUE=1&launch_id=1786732742&id_token=VjEAANPvmaE9rrDvVewvx9uobZt3dcrhLAKF3PWilDZmRz2KMPIpAnMlGDpcZxm%2F3OTx0vBkcym0cru4nx1PoqxFfPGR1VPypOsmYf0e9Q0Ust5Fn64V8faHJuCN%2BZLAVJdR0y6U&device_level=8&origin_channel=Xiaomi&overseas_channel=0&mlanguage=zh_cn&folder_type=none&auto_trans=0&t=1786732920&build=9420805&holder_ctry=CN&did=b348a0fa3719aa85e461e220fbad8ae0").addHeader("User-Agent", "Dalvik/2.1.0 (Linux; U; Android 16; 25079RPDCC Build/BP2A.250605.031.A3) Resolution/1880*3008 Version/9.42.0 Build/9420805 Device/(Xiaomi;25079RPDCC) discover/9.42.0 NetType/WiFi").addHeader("Referer", "https://app.xhs.cn/");
      var req = RB.build();
      try {
        var resp = client.newCall(req).execute();
        var body = resp.body().string();
        emit("+", "FULL_RESP_CODE=" + resp.code());
        emit("+", "FULL_RESP_BODY=" + body.substring(0, 200));
      } catch (e) {
        emit("!", "req fail: " + e);
      }
    } catch (e) {
